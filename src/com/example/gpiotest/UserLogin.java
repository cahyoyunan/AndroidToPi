...
String username = intent.getExtras().getString("userName");
		String DATABASE_NAME = username+".db";
		...
		public  UserLogin(Context _context) 
		{
			context = _context;
		...
		public  UserLogin open() throws SQLException 
		{
		...
		public Cursor readData() {
			String[] allColumns = new String[] { UserLogin.ID,
					UserLogin.USERNAME,UserLogin.KETERANGAN };
