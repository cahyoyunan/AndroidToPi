...
public class MainActivity2 extends Activity implements GPIO.PortUpdateListener,GPIO.ConnectionEventListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    this.gpioPort = new GPIO(new GPIO.ConnectionInfo("219.83.55.230", 8000,
        "webiopi", "raspberry"));
    ...
    button3.setOnClickListener(new View.OnClickListener() {
    	  public void onClick(View bebek) {
    		  Intent myIntent = new
    		  Intent(bebek.getContext(), camera2.class);
